...
export function FeaturesSection() {
  ...
  const services = [
    {
      title: settings.feature1Title || '12 years of experience',
      description:
      ...
      value: settings.feature1Value || '12+',
    },
    {
      title: settings.feature2Title || 'Team of professionals',
      description:
        'We have a team of professionals who are always ready to help you. Our team is a bunch of certified teachers.',
      icon: <Users className="h-8 w-8" />,
      color: 'bg-blue-100 text-blue-600',
      value: settings.feature2Value || '25+',
    },
    {
      title: settings.feature3Title || 'Dedicated Work',
      description:
      ...
      value: settings.feature3Value || '1.5k+',
    },
  ];
            ...
            <Card key={service.title} className="text-center shadow-lg">
              <CardContent className="p-8">
                ...
                >
                 ...
                 <p className="text-4xl font-bold text-gray-800 dark:text-white">{service.value}</p>
