...
export function WhatsappSupportButton() {
  const whatsappNumber = '923099969535';
  const prefilledMessage = 'Hello! I need support from your academy.';
  ...
  return (
    <Link
      ...
      className={cn(
        'fixed bottom-4 right-4 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg transition-transform hover:scale-110 md:h-16 md:w-16 print:hidden'
      )}
